 ...
 */
final class Version20250314084723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance CHANGE date_heure date_heure DATETIME NOT NULL, CHANGE coach_id_id coach_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance CHANGE date_heure date_heure DATE NOT NULL, CHANGE coach_id coach_id_id INT NOT NULL');
